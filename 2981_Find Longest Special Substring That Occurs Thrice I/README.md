<h2><a href="https://leetcode.com/problems/find-longest-special-substring-that-occurs-thrice-i/description/">Find Longest Special Substring That Occurs Thrice I</a>
</h2> 

`Difficulty` 🌕🌕🌕🌑🌑<br>
`Runtime`	47ms	(18.32%)<br>
`Memory`	17.5MB	(6.29%)
