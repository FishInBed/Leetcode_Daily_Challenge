<h2><a href="https://leetcode.com/problems/find-score-of-an-array-after-marking-all-elements">Find Longest Special Substring That Occurs Thrice I</a>
</h2> 

`Difficulty` 🌕🌕🌕🌑🌑<br>
`Runtime`	275ms	(92.00%)<br>
`Memory`	36.24MB	(92.28%)
